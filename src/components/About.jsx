      ...
      <div className='about__right'>
        <div className='about__content'>
          ...
          <p className='section__text'>
            ...
            analytics. I've most recently added software engineering to my skillset and am eager to provide a unique set
            of skills in the software sector. With a proven track record of people skills and coordination, I am excited
            to continue carving my niche in this world. There's nothing more rewarding than working hard and solving
